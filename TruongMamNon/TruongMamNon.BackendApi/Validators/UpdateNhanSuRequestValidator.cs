...
{
    public class UpdateNhanSuRequestValidator : AbstractValidator<UpdateNhanSuRequest>
    {
        public UpdateNhanSuRequestValidator(ICommonRepository commonRepository, IPhongBanRepository phongBanRepository, ILoaiNhanSuRepository loaiNhanSuRepository)
        {
