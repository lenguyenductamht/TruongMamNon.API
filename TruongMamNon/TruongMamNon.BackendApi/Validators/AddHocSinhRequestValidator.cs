...
namespace TruongMamNon.BackendApi.Validators
{
    public class AddHocSinhRequestValidator : AbstractValidator<AddHocSinhRequest>
    {
        ...
        {
            RuleFor(x => x.MaHocSinh).NotEmpty().WithMessage("Vui lòng nhập mã học sinh");
            ...
            RuleFor(x => x.MatKhau).MaximumLength(200).WithMessage("Mật khẩu không được vượt quá 200 ký tự");
