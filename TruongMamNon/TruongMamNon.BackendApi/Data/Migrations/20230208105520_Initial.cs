...
namespace TruongMamNon.BackendApi.Data.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "DotKhamSucKhoes",
                columns: table => new
                {
                    MaDotKhamSucKhoe = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TenDotKhamSucKhoe = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    NgayKhamSucKhoe = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    MaNienHoc = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DotKhamSucKhoes", x => x.MaDotKhamSucKhoe);
                    table.ForeignKey(
                        name: "FK_DotKhamSucKhoes_NienHocs_MaNienHoc",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MaNhanSu = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    MaPhongBan = table.Column<int>(type: "int", nullable: false),
                    MaTrangThaiLamViec = table.Column<string>(type: "nvarchar(1)", nullable: false),
                    ...
                    MaTrangThaiTaiKhoan = table.Column<string>(type: "nvarchar(1)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MaHocSinh = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Ho = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Ten = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    MaGioiTinh = table.Column<string>(type: "nvarchar(1)", maxLength: 1, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaNguoiNhap = table.Column<long>(type: "bigint", nullable: false),
                    GhiChu = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaNguoiXuat = table.Column<long>(type: "bigint", nullable: false),
                    GhiChu = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TrangThai = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaHocSinh = table.Column<long>(type: "bigint", nullable: false),
                    MaTrangThaiDiemDanh = table.Column<string>(type: "nvarchar(1)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.MaTrangThaiDiemDanh,
            ...
            migrationBuilder.CreateTable(
                name: "PhieuKhamSucKhoes",
                columns: table => new
                {
                    MaPhieuKhamSucKhoe = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MaDotKhamSucKhoe = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PhieuKhamSucKhoes", x => x.MaPhieuKhamSucKhoe);
                    table.ForeignKey(
                        name: "FK_PhieuKhamSucKhoes_DotKhamSucKhoes_MaDotKhamSucKhoe",
                        column: x => x.MaDotKhamSucKhoe,
                        principalTable: "DotKhamSucKhoes",
                        principalColumn: "MaDotKhamSucKhoe",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PhieuKhamSucKhoes_HocSinhs_MaHocSinh",
                        column: x => x.MaHocSinh,
                        principalTable: "HocSinhs",
                        principalColumn: "MaHocSinh",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "", "Thực đơn lớp mầm bữa sáng", "07:30" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, "012345678910", "HCM", "140 Lê trọng tấn", "lenguyenductamht@gmail.com", "", "", "Lê Nguyễn Đại Đức", "Long An", "Lê Huỳnh Nam", "", "01", "0", 4, 1, "704", "99", "0", "0", "Client@123", "1968", new DateTime(2023, 2, 8, 17, 55, 20, 71, DateTimeKind.Local).AddTicks(495), new DateTime(2022, 12, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2001, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "Tự do", "Long An", "0123456789", "Tâm" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, "123456789", "Tân Phú", "lenguyenductamcv@gmail.com", "", "Lê Nguyễn Đại Đức", "Long An", "", 3, "01", "0", null, 1, 1, "704", "99", "0", "0", "0e7517141fb53f21ee439b355b5a1d0a", null, new DateTime(2023, 2, 8, 17, 55, 20, 71, DateTimeKind.Local).AddTicks(679), new DateTime(2001, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2020, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "Long An", "123456789", "Tâm" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DotKhamSucKhoes_MaNienHoc",
                table: "DotKhamSucKhoes",
                column: "MaNienHoc");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PhieuKhamSucKhoes_MaDotKhamSucKhoe",
                table: "PhieuKhamSucKhoes",
                column: "MaDotKhamSucKhoe");

            migrationBuilder.CreateIndex(
                name: "IX_PhieuKhamSucKhoes_MaHocSinh",
                table: "PhieuKhamSucKhoes",
                column: "MaHocSinh");
